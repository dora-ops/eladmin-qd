<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column prop="content" label="奖惩详情"/>
      <el-table-column prop="handleUname" label="处理人姓名"/>
      <el-table-column label="操作" width="150px" align="center">
        <template slot-scope="scope">
          <edit v-if="checkPermission(['USER_ALL'])" :data="scope.row" :sup_this="sup_this"/>
          <el-popover
