<template>
    <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isAdd ? '新增' : '编辑'" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
                        ...
                        <el-form-item label="用户名" prop="cusNickname">
                        <el-input v-model="form.cusNickname" style="width: 370px;"/>
                    </el-form-item>
                <el-form-item label="评论内容" prop="comment">
                        <el-input v-model="form.comment" style="width: 370px;"/>
                    </el-form-item>
                <el-form-item label="评论用户id" prop="cusId">
                ...
                <el-form-item label="发布id" prop="pubId">
                    <el-input v-model="form.pubId" style="width: 370px;"/>
                        <!-- <el-select v-model="form.pubId" placeholder="请选择" style="width: 370px;">
                            <el-option v-for="item in options" :key="item.id" :label="item.name" :value="item.id">
                            </el-option>
                        </el-select> -->
                    </el-form-item>
        ...
        data() {
            return {
                ...
                rules: {
                        ...
                        pubId: [
                            {required: true, message: '发布id不能为空', trigger: 'blur'}
                        ]
                },
                options:[]
            }
