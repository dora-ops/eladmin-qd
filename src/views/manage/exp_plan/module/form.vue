<template>
    <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isAdd ? '新增' : '编辑'" width="500px">
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
            ...
            <el-form-item label="实验房间编号" prop="roomNumber">
            ...
            <el-form-item label="实验地点" prop="expAddress">
                <el-input v-model="form.expAddress" style="width: 370px;" />
            </el-form-item>
            <el-form-item label="容纳人数" prop="hold">
                <el-input v-model="form.hold" style="width: 370px;" />
            </el-form-item>
            <el-form-item label="剩余人数" prop="remaind">
                <el-input v-model="form.remaind" style="width: 370px;" />
            </el-form-item>
        </el-form>
...
<script>
import { add, edit } from "@/api/expPlan";
import { course, userOpt,experiment } from "@/sqlMap";
export default {
  props: {
    isAdd: {
      type: Boolean,
  ...
  data() {
    return {
      ...
      rules: {
        ...
        startTime: [
          { required: true, message: "实验开始时间", trigger: "blur" }
        ],
        endTime: [{ required: true, message: "实验开始时间", trigger: "blur" }]
      },
       course_opt:[],
      tea_opt:[],
      exp_opt:[]
